...
export const ui = {
  es: {
    ...
    "home.experiences.subtitle": "La naturaleza del Delta te ofrece momentos que no se olvidan",
    "home.fishing.title": "Pesca",
    "home.fishing.desc": "Lanzá el anzuelo en aguas tranquilas rodeadas de aves y silencio. El Delta del Paraná es uno de los mejores destinos de pesca de Argentina.",
    "home.rowing.title": "Remo",
    "home.rowing.desc": "Explorá arroyos serenos en la piragua de la cabaña. Cada recodo esconde un paisaje distinto, siempre en calma.",
    "home.relax.title": "Descanso Profundo",
    "home.relax.desc": "Desconectate del ruido de la ciudad. Sin aglomeraciones, sin prisa. Solo el murmullo del río y el canto de los pájaros.",
    "home.story.eyebrow": "Nuestra Cabaña",
    "home.story.heading": "Construida a mano, a orillas del Arroyo Fredes",
    "home.story.body": "En la 2° sección del Delta, dentro de una reserva de biosfera, esta cabaña fue construida artesanalmente con materiales locales y reciclados. Dos pisos sobre el agua, rodeados de flora nativa que crece y florece cada temporada.",
    ...
    "home.amenity.linens": "Ropa de Cama",
  ...
  en: {
    ...
    "home.experiences.subtitle": "The Delta's nature offers moments you will never forget",
    "home.fishing.title": "Fishing",
    "home.fishing.desc": "Cast your line in calm waters surrounded by birds and silence. The Paraná Delta is one of Argentina's finest fishing destinations.",
    "home.rowing.title": "Rowing",
    "home.rowing.desc": "Explore serene creeks in the cabin's kayak. Every bend hides a new landscape, always calm and beautiful.",
    "home.relax.title": "Deep Rest",
    "home.relax.desc": "Disconnect from city noise. No crowds, no rush. Just the murmur of the river and birdsong filling the air.",
    "home.story.eyebrow": "The Cabin",
    "home.story.heading": "Hand-built on the banks of Arroyo Fredes",
    "home.story.body": "In the 2nd section of the Delta, within a biosphere reserve, this cabin was hand-built using local and recycled materials. Two floors over the water, surrounded by native flora that grows and blooms each season.",
  ...
  pt: {
    ...
    "home.experiences.subtitle": "A natureza do Delta oferece momentos inesquecíveis",
    "home.fishing.title": "Pesca",
    "home.fishing.desc": "Lance sua linha em águas tranquilas cercadas de aves e silêncio. O Delta do Paraná é um dos melhores destinos de pesca da Argentina.",
    "home.rowing.title": "Remo",
    "home.rowing.desc": "Explore riachos serenos no caiaque da cabana. Cada curva esconde uma paisagem diferente, sempre tranquila e bela.",
    "home.relax.title": "Descanso Profundo",
    "home.relax.desc": "Desconecte-se do barulho da cidade. Sem multidões, sem pressa. Apenas o murmúrio do rio e o canto dos pássaros.",
    "home.story.eyebrow": "A Cabana",
    "home.story.heading": "Construída à mão, às margens do Arroyo Fredes",
    "home.story.body": "Na 2ª seção do Delta, dentro de uma reserva da biosfera, esta cabana foi construída artesanalmente com materiais locais e reciclados. Dois andares sobre a água, cercados de flora nativa que cresce e floresce a cada temporada.",
